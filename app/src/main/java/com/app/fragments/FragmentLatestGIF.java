...
import com.app.asyncTask.LoadGIF;
import com.app.screenie.GIFsDetailsActivity;
import com.app.screenie.R;
import com.app.interfaces.GIFListener;
...
public class FragmentLatestGIF extends Fragment {
    ...
    private void getLatestData() {
        if (methods.isNetworkAvailable()) {
            ...
            if (pos == 0) {
                requestBody = methods.getAPIRequest(Constant.METHOD_LATEST_GIF, page, "", "", "", "", "", "", "", "", "", "", Constant.itemUser.getId(), "");
            } else if (pos == 1) {
                requestBody = methods.getAPIRequest(Constant.METHOD_MOST_VIEWED_GIF, page, "", "", "", "", "", "", "", "", "", "", Constant.itemUser.getId(), "");
            } else if (pos == 2) {
                requestBody = methods.getAPIRequest(Constant.METHOD_MOST_RATED_GIF, page, "", "", "", "", "", "", "", "", "", "", Constant.itemUser.getId(), "");
            }
