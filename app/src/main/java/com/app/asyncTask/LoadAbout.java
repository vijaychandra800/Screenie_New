            ...
            if (jsonObject.has(Constant.TAG_ROOT)) {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    if (!c.has(Constant.TAG_SUCCESS)) {
                        ...
                        if(Boolean.parseBoolean(c.getString("banner_ad"))) {
                            Constant.isBannerAd = true;
                            Constant.ad_banner_id = c.getString("banner_ad_id");
                        } else if(Boolean.parseBoolean(c.getString("facebook_banner_ad"))) {
                            Constant.isBannerAd = true;
                            Constant.ad_banner_id = c.getString("facebook_banner_ad_id");
                        } else {
                            Constant.isBannerAd = false;
                        }

                        if(Boolean.parseBoolean(c.getString("interstital_ad"))) {
                            Constant.isInterAd = true;
                        ...
                        } else if(Boolean.parseBoolean(c.getString("facebook_interstital_ad"))) {
                            Constant.isInterAd = true;
                            Constant.ad_inter_id = c.getString("facebook_interstital_ad_id");
                            if(!c.getString("facebook_interstital_ad_click").equals("")) {
                                Constant.adInterstitialShow = Integer.parseInt(c.getString("facebook_interstital_ad_click"));
                            }
                        } else {
                            Constant.isInterAd = false;
                        }

                        if(Boolean.parseBoolean(c.getString("admob_nathive_ad"))) {
                            Constant.isNativeAd = true;
                            Constant.ad_native_id = c.getString("admob_native_ad_id");
                            if(!c.getString("admob_native_ad_click").equals("")) {
                                Constant.adNativeShow = Integer.parseInt(c.getString("admob_native_ad_click"));
                            }
                        } else if(Boolean.parseBoolean(c.getString("facebook_native_ad"))) {
                            Constant.isNativeAd = true;
                            Constant.ad_native_id = c.getString("facebook_native_ad_id");
                            if(!c.getString("facebook_native_ad_click").equals("")) {
                                Constant.adNativeShow = Integer.parseInt(c.getString("facebook_native_ad_click"));
                            }
                        } else {
