...
public class Methods {
    ...
    private void changeAutoLogin(Boolean isAutoLogin) {
        SharedPref sharePref = new SharedPref(context);
        sharePref.setIsAutoLogin(isAutoLogin);
    }

    public void logout(Activity activity) {
        if (Constant.itemUser.getLoginType().equals(Constant.LOGIN_TYPE_FB)) {
            LoginManager.getInstance().logOut();
        } else if (Constant.itemUser.getLoginType().equals(Constant.LOGIN_TYPE_GOOGLE)) {
...
//        }
    ...
    public void showBannerAd(LinearLayout linearLayout) {
        if (isNetworkAvailable() && linearLayout != null && Constant.isBannerAd) {
    ...
    public class LoadShare extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if (option.equals(context.getString(R.string.download))) {
                ...
                Log.d("URISET", String.valueOf(Constant.uri_set));
                if (postType.equals("wallpaper")) {
