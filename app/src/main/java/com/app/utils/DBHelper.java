...
public class DBHelper extends SQLiteOpenHelper {
        ...
        if (cursor != null && cursor.getCount() > 0) {
            ...
            for (int i = 0; i < cursor.getCount(); i++) {
                ...
                if(colors_array_selected.size() > 0) {
                    ...
                    ItemWallpaper itemWallpaper = new ItemWallpaper(pid, cid, cname, img, img_thumb, colors, views, totalrate, averagerate, download, tags, wallUrl, app1Url, app2Name, app2Url, app3Name, app3Url,app4Name,app4Url,app5Name,app5Url,type, false);
                    itemWallpaper.setResolution(res);
                    itemWallpaper.setSize(size);
                    arrayList.add(itemWallpaper);
                }
    ...
    public void addtoCatList(ItemCat itemCategory) {
        String image = methods.encrypt(itemCategory.getImage().replace(" ", "%20"));
