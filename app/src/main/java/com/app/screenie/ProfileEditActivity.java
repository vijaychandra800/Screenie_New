...
public class ProfileEditActivity extends AppCompatActivity {
    ...
    private void loadUpdateProfile() {
        if (methods.isNetworkAvailable()) {
            ...
            }, methods.getAPIRequest(Constant.METHOD_EDIT_PROFILE,0,"","","","","","",editText_name.getText().toString(),editText_email.getText().toString(),editText_pass.getText().toString(),editText_phone.getText().toString(), sharedPref.getUserId(), ""));
