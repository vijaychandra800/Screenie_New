            ...
            LoadRegister loadRegister = new LoadRegister(new SocialLoginListener() {
                ...
                public void onEnd(String success, String registerSuccess, String message, String user_id, String user_name, String email, String auth_id) {
                    ...
                    if (success.equals("1")) {
                        ...
                        Toast.makeText(RegisterActivity.this, getString(R.string.server_no_conn), Toast.LENGTH_SHORT).show();
                    }
                }
            }, methods.getAPIRequest(Constant.METHOD_REGISTRATION, 0, "", Constant.LOGIN_TYPE_NORMAL, "", "", "", "", editText_name.getText().toString(), editText_email.getText().toString(), editText_pass.getText().toString(),editText_phone.getText().toString(),"", ""));
